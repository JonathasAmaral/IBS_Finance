...
export default function YouTubeButton({ linkYoutube }: YouTubeButtonProps) {
    return (
        <a href={linkYoutube} target="_blank" rel="noopener noreferrer" className="flex h-8 w-8 items-center justify-center rounded-full border border-white hover:bg-white/20">
